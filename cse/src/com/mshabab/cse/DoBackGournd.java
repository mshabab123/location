...
public class DoBackGournd extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		double locatins1 = loca.getLongitude();
		...
		post_loc = this.encode(locatins2, locatins1);
	...
	class PostLocation extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(DoBackGournd.this);
		...
		protected void onPostExecute(String file_url) {
			...
			pDialog.dismiss();
			if (file_url != null) {
				Toast.makeText(DoBackGournd.this, file_url, Toast.LENGTH_LONG)
						.show();
			}
