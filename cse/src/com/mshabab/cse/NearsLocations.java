...
public class NearsLocations extends ListActivity {
...
double Latit, lontit; 
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		distance1 = Maps.Distance1; 
		location1 =Maps.latitude1;
		location2 =Maps.longitude1;
		
		if (distance1.isEmpty())
			distance1="1588888888888" ;
	...
	public void updateJSONdata() {
		...
		try {
			...
			for (int i = 0; i < mComments.length(); i++) {
				...
				distance250 = CalculationByDistance(location1 ,location2,  Latit,   lontit   );
				
								
				
			int d = (int)distance250;
			loc1 = String.valueOf(d);
			distance22 = Integer.parseInt(distance1);

			if (distance22 > distance250)
			{
	...
	private void updateList() {
		...
		ListAdapter adapter = new SimpleAdapter(this, mCommentList,
				R.layout.single_location, new String[] { 
				TAG_user, TAG_loc, TAG_desc,TAG_times  }, new int[] {
				R.id.location ,R.id.username , R.id.descoiption	, R.id.times1 });
	...
	Intent i = new Intent(NearsLocations.this, Blank.class);
	...
	public class LoadComments extends AsyncTask<Void, Void, Boolean> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(NearsLocations.this);
